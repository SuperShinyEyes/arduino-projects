...
void changeTime(){
	...
	void (DS3231::changeFunctions[5]) (byte t);

	changeFunctions[0] = Clock.setMonth;
	//changeFunctions[1] = Clock.setDate;
	//changeFunctions[2] = Clock.setDoW;
	//changeFunctions[3] = Clock.setHour;
	//changeFunctions[4] = Clock.setMinute;
